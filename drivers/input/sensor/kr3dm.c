...
//20100810 myeonggyu.son@lge.com [MS690] suspend&resume control [START]
#if defined(CONFIG_HAS_EARLYSUSPEND)
static void kr3dm_early_suspend(struct early_suspend *h)
{
	kr3dm_misc_data->pdata->gpio_config(0);
...
static void kr3dm_late_resume(struct early_suspend *h)
{
	kr3dm_misc_data->pdata->gpio_config(1);
...
#endif
//20100810 myeonggyu.son@lge.com [MS690] suspend&resume control [END]
