...
/*	{0xf9, 4,  {0x24, 0x00, 0x00, 0x00}},
	...
	{0xfa, 16, {0x2D, 0x00, 0x08, 0x26, 0x2A, 0x2B, 0x32, 0x0B,
				0x13, 0x10, 0x03, 0x02, 0x00, 0x00, 0x00, 0x00}},

	{0xf9, 4,  {0x21, 0x00, 0x00, 0x00}},

	{0xfa, 16, {0x1E, 0x01, 0x08, 0x28, 0x2B, 0x2F, 0x32, 0x0E,
				0x16, 0x12, 0x06, 0x04, 0x00, 0x00, 0x00, 0x00}},				
	*/
	
	{0xf9, 4,  {0x24, 0x00, 0x00, 0x00}},

	{0xfa, 16, {0x03, 0x03, 0x08, 0x2B, 0x2B, 0x2F, 0x2D, 0x16,
				0x23, 0x23, 0x23, 0x23, 0x11, 0x00, 0x00, 0x00}},
	...
	{0xfa, 16, {0x03, 0x03, 0x0D, 0x2F, 0x2F, 0x34, 0x36, 0x10,
				0x1B, 0x1B, 0x18, 0x16, 0x0A, 0x00, 0x00, 0x00}},				
#endif
...
//	g_mddi_lcd_probe = 0;
	...
	printk("hitachi Mfd ID : %x\n", id);

	//if id is 0, this means Hitachi LCD.
	if(id != 0)
		return -ENODEV;
