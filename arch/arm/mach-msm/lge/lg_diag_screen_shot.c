        ...
        uint16		pkt_len )		      /* length of request packet   */
{
  ...
  switch(req_ptr->lcd_bk_ctrl.sub_cmd_code)
  {
    ...
    case SCREEN_SHOT_LCD_BUF:
	  ...
	  /* LGE_CHANGE [yongman.kwon@lge.com] 2010-08-20 [START]*/
	  rsp_ptr->lcd_buf.x = 0;
	  rsp_ptr->lcd_buf.y = 0; 
	  rsp_ptr->lcd_buf.is_main_lcd = 0; 
	  rsp_ptr->lcd_buf.width = LCD_MAIN_WIDTH;
	  rsp_ptr->lcd_buf.height = LCD_MAIN_HEIGHT;	 
	  /* LGE_CHANGE [yongman.kwon@lge.com] 2010-08-20 [END]*/
        ...
        case SEQ_GET_BUF:
	      ...
	      /* LGE_CHANGE [yongman.kwon@lge.com] 2010-08-20 */
