...
//20100819 myeonggyu.son@lge.com [MS690] mtc touch logging [START]
extern uint16_t max_x;
extern uint16_t max_y;
//20100819 myeonggyu.son@lge.com Write[MS690] mtc touch logging [END]
...
//20100819 myeonggyu.son@lge.com [MS690] mtc touch logging [START]
#if 1
	pRsp->mtc_rsp.log_data.log_type.log_data_touch.x = (unsigned short)(p_ats_mtc_key_log->x_hold*320/max_x);
	pRsp->mtc_rsp.log_data.log_type.log_data_touch.y = (unsigned short)(p_ats_mtc_key_log->y_code*480/max_y);
#else
...
#endif
//20100819 myeonggyu.son@lge.com [MS690] mtc touch logging [END]
