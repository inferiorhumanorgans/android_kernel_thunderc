...
//20100721 hyeongwoo.seo@lge.com MS690: Not Supported 
#undef CONFIG_CARKIT_DEVICE
...
//20100721 hyeongwoo.seo@lge.com MS690: Not Supported [START]
#if defined(CONFIG_CARKIT_DEVICE)
...
#endif
//20100721 hyeongwoo.seo@lge.com MS690: Not Supported [END]
...
//20100720 hyeongwoo.seo@lge.com MS690: Merge from LS670 [START]
#if 1
	int retry = 3;
	int ret = 0;
	int en = !!enable;
	...
	return -EIO;
//20100720 hyeongwoo.seo@lge.com MS690: Merge from LS670 [END]
#else	
	if (dev==NULL) {
		printk(KERN_ERR "%s: backlight devive get failed\n", __FUNCTION__);
		return -1;
...
{
//20100719 hyeongwoo.seo@lge.com MS690 : Modified  for Q-gate [START]
#if 1
	int gain = ((PWM_MAX_HALF_DUTY*amp) >> 7)+ GPMN_D_DEFAULT;
	if (enable) {
		/* LGE_CHANGE_S, [kidong0420.kim@lge.com] , 2010-06-18, GPIO configuration for current consumption*/
	  	gpio_tlmm_config(GPIO_CFG(GPIO_LIN_MOTOR_PWM, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_2MA), GPIO_ENABLE);
	  	/* LGE_CHANGE_E, [kidong0420.kim@lge.com] , 2010-06-18, GPIO configuration for current consumption*/
...
#else
//20100719 hyeongwoo.seo@lge.com Modified  for Q-gate [END]
...
// LGE_CHANGE from LS670 for US670 [dojip.kim@lge.com] 2010-09-03, 110
	.amp_value = 110,
};
...
//20100720 hyeongwoo.seo@lge.com MS690] Not Used [START]
		#if 0
		...
		#endif
//20100720 hyeongwoo.seo@lge.com MS690] Not Used [END]
	} else {
...
void __init lge_add_misc_devices(void)
{
	...
	//20100722 yongman.kwon@lge.com MS690 : Use backlight current.
