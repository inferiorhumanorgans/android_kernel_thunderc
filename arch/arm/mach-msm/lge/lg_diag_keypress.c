...
//20100810 yongman.kwon@lge.com MS690 : add key value for UTS [START]
//	  {0x4E 	   ,   243 },	  // folder home
//	  {0x4F 	   ,   244 },	  // folder menu
	{0x4E		 ,	 KEY_HOME}, 	// folder home
	{0x4F		 ,	 KEY_MENU}, 	// folder menu
//20100810 yongman.kwon@lge.com MS690 : add key value for UTS [END]
    {0x50        ,   KEY_SEND },
    {0x51        ,   KEY_END },
    {0x92        ,   KEY_VOLUMEUP },
    {0x93        ,   KEY_VOLUMEDOWN},
    {0x8F        ,   KEY_CAMERA },
//20100810 yongman.kwon@lge.com US670 : add key value for UTS [START]
//power,search,back, 
    {0x6B		 , 	 KEY_POWER},
    {0xD9		 , 	 KEY_SEARCH},
    {0x9E		 , 	 KEY_BACK},
    {0x9F		 , 	 KEY_CHAT},
//20100810 yongman.kwon@lge.com US670 : add key value for UTS [END]      
    {0x23     ,   228}, // pound
    {0x2A     ,   227}, // star
